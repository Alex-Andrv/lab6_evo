...
public class IslandsAlg {
    ...
    public static void main(String[] args) {
        ...
        int generations = 20000 / 50; // number of generations
        ...
        IslandEvolution<double[]> island_model = new IslandEvolution<double[]>(5, // Number of islands.
                new RingMigration(),
                factory,
                pipeline,
                evaluator,
        ...
        island_model.evolve(populationSize, 5, 50, 5, terminate);
    }
}
